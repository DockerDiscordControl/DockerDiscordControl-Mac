...
### ✅ **v2.1.4.1 (2026-03-08) - Security Patch**

🔒 **Security Fixes:**
- **Pillow**: Upgrade to >=12.1.1 - Fix for CVE-2026-25990 (out-of-bounds write when loading PSD images)
- **cryptography**: Upgrade to >=46.0.5 - Fix for CVE-2026-26007 (SECT curves subgroup attack)
- **Werkzeug**: Upgrade to >=3.1.6 - Fix for CVE-2026-27199 (safe_join device name bypass)
- **Flask**: Upgrade to >=3.1.3 - Fix for CVE-2026-27205 (missing Vary: Cookie header)
